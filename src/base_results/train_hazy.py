...
class Dataset(torch.utils.data.Dataset):
	def __init__(self, list_IDs, files, tranform):
...
def main():
	...
	train_dataset = Dataset(ids_train, files_train, transforms.Compose([transforms.Resize((256,256)),transforms.ToTensor(),])) # normalize
